...
# Above Jump
execute positioned as @s unless block ^ ^1 ^ #expai:non_solids if block ^ ^2 ^ #expai:non_solids if block ^ ^3 ^ #expai:non_solids run function expai:raycast/jump/gap_determiner_detect
# Below Jump
execute positioned as @s unless block ^ ^-1 ^ #expai:non_solids if block ^ ^ ^ #expai:non_solids if block ^ ^1 ^ #expai:non_solids if block ^ ^-1 ^-1 #expai:non_solids run function expai:raycast/jump/gap_determiner_detect
# Same Level Jump
execute positioned as @s unless block ^ ^ ^ #expai:non_solids if block ^ ^1 ^ #expai:non_solids if block ^ ^2 ^ #expai:non_solids run function expai:raycast/jump/gap_determiner_detect
...
#Loop
execute if entity @s[tag=!expai.cast_found_gap_length,scores={expai.raycast_steps=1..}] unless entity @s[tag=expai.invalid] positioned as @s run function expai:raycast/jump/gap_determiner_find_gap_length